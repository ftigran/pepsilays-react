        ...
        >
          <Fade in={this.props.error}>
            <div className={"modalWindow SimpleModal"}>
              ...
              <p className={"SimpleModalText"}>Проверьте поля</p>
              <Button className={"modalBtn"} onClick={this.props.toggleError}>
                ОК
              </Button>
            </div>
          </Fade>
...
export const WrapedUserError = connect(
  mapStateToProps,
  putActionsToProps
)(UserLoginErrorModal);
...
import { toggleError } from "../../../store/actions";
