  ...
  render() {
    return (
      ...
      >
        ...
        <p className="cabinetSrok">
          Срок регистрации чеков: <br />с 10.02.2021 по 25.03.2021 года
        </p>
        <div className="cabinetCard">
          <div className="cabinetInfo">
            <div className="cabinetMyStat">
              <p>
                Мои призы <span>{this.props.user.prizi}</span>
              </p>
              <p>
                Мои чеки <span>{this.props.user.cheki}</span>
              </p>
            </div>
            <div className="checkboxWrap">
              ...
              <Checkbox>
                Я согласен получать информацию об акции по sms
              </Checkbox>
            </div>
          ...
          <div className="cabinetRegCheki">
            ...
            <p>
              В чеке должно быть минимум два акционных продукта.
              <br />
              На фото должны быть чётко видны данные чека и QR-код.
            </p>
            <CheckRequirementsModal
              mainBtnVariant="outlined"
              mainBtnColor="primary"
            />
            <Button color="primary">Зарегистрировать чек</Button>
          </div>
        </div>
        <SimpleTabs />
      </Grid>
  ...
  return (
    <div className="tabpage">
      ...
      <TabPanel value={value} index={0}>
        <Table columns={ColumnsCheki} rows={rowsCheki} rowsPerPage={5} />
      </TabPanel>
      <TabPanel value={value} index={1}>
        <Table columns={ColumnsPrizi} rows={rowsPrizi} rowsPerPage={5} />
      </TabPanel>
    </div>
  );
}
