      ...
      >
        <Grid item component="form" className={"Registration"}>
          ...
          <div className="checkboxs">
            <Checkbox>
              Я прочитал и согласен с <a href="empty">Правилами акции</a> и{" "}
              <a href="empty">Пользовательским соглашением</a>, согласен на
              обработку персональных данных
            </Checkbox>
            <Checkbox>
              Я согласен получать информацию об акции по E-mail
            </Checkbox>
            <Checkbox>Я согласен получать информацию об акции по СМС</Checkbox>
          </div>
          {verify}
        </Grid>
      </Grid>
